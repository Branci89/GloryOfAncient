                ...
                <div class="form_gioco">
                    <form action = "<?php echo $_SERVER['SCRIPT_NAME'] . '?' . $_SERVER['QUERY_STRING']; ?>" method="post">
                        ...
                        <div class="form_field" >
                            <select name="genere">
                                <option value="m" <?php
                                if (gdrcd_filter('get', $_POST['genere']) == 'm') {
                                    echo 'SELECTED';
                                }
                                ?> >
                                ...
                                <option value="f" <?php
                                if (gdrcd_filter('get', $_POST['genere']) == 'f') {
                                    echo 'SELECTED';
                                }
                                ?> >
                        ...
                        <div class="form_field" >
                            <select name="razza">
                                <?php while ($row = gdrcd_query($result, 'fetch')) { ?>
                                    <option value="<?php echo $row['id_razza']; ?>" <?php
                                    if (gdrcd_filter('get', $_POST['razza']) == $row['id_razza']) {
                                        echo 'SELECTED';
                                    }
                                    ?>>
                        ...
                        <!-- Nazione -->
                        <div class="form_label" >
                            <?php echo htmlentities(gdrcd_filter('out', $PARAMETERS['names']['nationality']['sing'] . ' ' . $MESSAGE['register']['fields']['nationality'])); ?>
                        </div>
                        <?php $result = gdrcd_query("SELECT id_nazione, nome_nazione FROM nazione WHERE iscrizione=1 ORDER BY id_nazione", 'result'); ?>
                        <div class="form_field" >
                            <select name="nazione">
                                <?php while ($row = gdrcd_query($result, 'fetch')) { ?>
                                    <option value="<?php echo $row['id_nazione']; ?>" <?php
                                    if (gdrcd_filter('get', $_POST['nazione']) == $row['id_nazione']) {
                                        echo 'SELECTED';
                                    }
                                    ?>>
                                                <?php echo gdrcd_filter('out', $row['nome_nazione']); ?>
                                    </option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="form_field" >
                            <table><tr>
                                    <td>
                                        ...
                                        <select name="car0">
                                            <?php for ($i = 5; $i <= $PARAMETERS['settings']['initial_cars_cap']; $i++) { ?>
                                                <option value="<?php echo $i; ?>" <?php
                                                if (gdrcd_filter('num', $_POST['car0']) == $i) {
                                                    echo 'SELECTED';
                                                }
                                                ?> >
                                                            <?php echo $i; ?>
                                    ...
                                    <td>
                                        ...
                                        <select name="car1">
                                            <?php for ($i = 5; $i <= $PARAMETERS['settings']['initial_cars_cap']; $i++) { ?>
                                                <option value="<?php echo $i; ?>" <?php
                                                if (gdrcd_filter('num', $_POST['car1']) == $i) {
                                                    echo 'SELECTED';
                                                }
                                                ?> >
                                                            <?php echo $i; ?>
                                    ...
                                    <td>
                                        ...
                                        <select name="car2">
                                            <?php for ($i = 5; $i <= $PARAMETERS['settings']['initial_cars_cap']; $i++) { ?>
                                                <option value="<?php echo $i; ?>" <?php
                                                if (gdrcd_filter('num', $_POST['car2']) == $i) {
                                                    echo 'SELECTED';
                                                }
                                                ?> >
                                                            <?php echo $i; ?>
                                    ...
                                    <td>
                                        ...
                                        <select name="car3">
                                            <?php for ($i = 5; $i <= $PARAMETERS['settings']['initial_cars_cap']; $i++) { ?>
                                                <option value="<?php echo $i; ?>" <?php
                                                if (gdrcd_filter('num', $_POST['car3']) == $i) {
                                                    echo 'SELECTED';
                                                }
                                                ?> >
                                                            <?php echo $i; ?>
                                    ...
                                    <td>
                                        ...
                                        <select name="car4">
                                            <?php for ($i = 5; $i <= $PARAMETERS['settings']['initial_cars_cap']; $i++) { ?>
                                                <option value="<?php echo $i; ?>" <?php
                                                if (gdrcd_filter('num', $_POST['car4']) == $i) {
                                                    echo 'SELECTED';
                                                }
                                                ?> >
                                                            <?php echo $i; ?>
                                    ...
                                    <td>
                                        ...
                                        <select name="car5">
                                            <?php for ($i = 5; $i <= $PARAMETERS['settings']['initial_cars_cap']; $i++) { ?>
                                                <option value="<?php echo $i; ?>" <?php
                                                if (gdrcd_filter('num', $_POST['car5']) == $i) {
                                                    echo 'SELECTED';
                                                }
                                                ?> >
                                                            <?php echo $i; ?>
        ...
        if (gdrcd_filter('get', $_POST['fase']) == 2) {
            ...
            <div class="panels_box">
                ...
                if ($ok == FALSE) {
                    ...
                    <div class="form_gioco">
                        <form action = "<?php echo $_SERVER['SCRIPT_NAME'] . '?' . $_SERVER['QUERY_STRING']; ?>" method="post">
                            <div class="form_submit">
                                ...
                                <input type="hidden" name="nazione" value="<?php echo gdrcd_filter('num', $_POST['nazione']) ?>" />
                    ...
                    $nazione = gdrcd_query("SELECT sing_" . gdrcd_filter('in', $r_gen) . " AS nome_nazione FROM nazione WHERE id_nazione = " . (0 + gdrcd_filter('num', $_POST['nazione'])) . " LIMIT 1");
                    ?>
                    <div class="elenco_gioco">
                        <table>
                            ...
                            <tr><td class='casella_elemento'><div class='elementi_elenco'>
                                        <?php echo gdrcd_filter('out', $nazione['nome_nazione']) . '&nbsp;' ?>
                                    </div></td></tr>
                            <tr><td class='casella_elemento'><div class='elementi_elenco'>
...
//TNLFJDTM
                ...
                gdrcd_query("INSERT INTO personaggio (nome, cognome, pass, data_iscrizione, email, sesso, id_razza, id_nazione, car0, car1, car2, car3, car4, car5, salute, salute_max, soldi, esperienza $lastpasschange_field) VALUES ('" . gdrcd_capital_letter(gdrcd_filter('in', $_POST['nome'])) . "', '" . gdrcd_filter('in', $_POST['cognome']) . "', '" . gdrcd_encript($pass) . "', NOW(), '" . gdrcd_filter('in', $_POST['email']) . "', '" . gdrcd_filter('in', $_POST['genere']) . "', " . gdrcd_filter('num', $_POST['razza']) . ", " . gdrcd_filter('num', $_POST['nazione']) . ", " . gdrcd_filter('num', $_POST['car0']) . ", " . gdrcd_filter('num', $_POST['car1']) . ", " . gdrcd_filter('num', $_POST['car2']) . ", " . gdrcd_filter('num', $_POST['car3']) . ", " . gdrcd_filter('num', $_POST['car4']) . ", " . gdrcd_filter('num', $_POST['car5']) . ", " . gdrcd_filter('num', $PARAMETERS['settings']['max_hp']) . ", " . gdrcd_filter('num', $PARAMETERS['settings']['max_hp']) . ", " . gdrcd_filter('num', $PARAMETERS['settings']['first_money']) . ", " . gdrcd_filter('num', $PARAMETERS['settings']['first_px']) . " $lastpasschange_value)");
