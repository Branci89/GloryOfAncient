...
$add_chat = '
        ...
        <body class="main_body" style="overflow:auto; text-align:justify; margin: 40px;">
        ';
...
while ($row = gdrcd_query($query, 'fetch')) {
    ...
    switch ($row['tipo']) {
        ...
        case 'A':
            ...
            $add_chat .= '<span class="chat_name">Sussurro Globale by ' . $row['mittente'] . ': </a>';
        ...
        case 'N':
            ...
            $add_chat .= '<span style="color: #84bcd2; font-size: 16px; text-align: center; font-weight: 400; margin-left: 50%;"><u>PNG</u></span>';
            $add_chat .= '<br />';
            $add_chat .= '<br />';
        ...
        case 'M':
            ...
            $add_chat .= '<span style="color: #84bcd2; font-size: 16px; text-align: center; font-weight: 400; margin-left: 49.3%;"><u>MASTER</u></span>';
            $add_chat .= '<br />';
            $add_chat .= '<br />';
			$add_chat .= '<span class="chat_time">' . gdrcd_format_time($row['ora']) . '</span>';
