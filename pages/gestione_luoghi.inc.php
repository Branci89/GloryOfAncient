...
<?php /*Form di inserimento/modifica*/
    ...
    <form action="main.php?page=gestione_luoghi"
	      method="post"
		  class="form_gestione">
          ...
          <div class='form_field'>
	         <input name="nome" 
			        value="<?php echo gdrcd_filter('out',$loaded_location['nome']); ?>" />
		  </div>
		  ...
		  <div class='form_field'>
	         <input type="checkbox"
		            name="chat" 
		         <?php if (($loaded_location['chat']==1)||(isset($loaded_location)===FALSE)) {?>
					checked="checked"
				 <?php } ?>
					value="is_chat" />
		  </div>
		  <div class='form_info'>
			...
			<div class='form_field'>
				<input name="image_button" 
						value="<?php echo gdrcd_filter('out',$loaded_location['link_immagine']); ?>" />
			</div>
			<div class="form_info">
			...
			<div class='form_field'>
				<input name="image_button_hover" 
						value="<?php echo gdrcd_filter('out',$loaded_location['link_immagine_hover']); ?>" />
			</div>
			<div class="form_info">
		  ...
		  <div class='form_field'>
	         <input name="pagina" 
		            value="<?php echo gdrcd_filter('out',$loaded_location['pagina']); ?>" />
		  </div>
	         ...
	         <?php /* Carico l'elenco delle mappe inserite */
			   ...
			   if(gdrcd_query($mappe, 'num_rows') > 0){ ?>
		         ...
		         <select name="mappa_linked">
				    <!-- Opzione "Nessuna" -->
				    <option value="0"><?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['locations']['map_id_default']); ?></option><!-- Opzione "Nessuno" -->
               ...
               <?php } else { /*Altrimenti segnalo l'assenza di mappe*/
		  ...
		  <div class='form_field'>
	         <input name="immagine" 
				    value="<?php echo gdrcd_filter('out',$loaded_location['immagine']); ?>" />
		  </div>
		  <div class='form_info'>
		  ...
		  <div class='form_field'>
	         <input name="stanza_apparente" 
		            value="<?php echo gdrcd_filter('out',$loaded_location['stanza_apparente']); ?>" />
		  </div>
		  <div class='form_info'>
		  ...
		  <div class='form_field'>
	         <?php /* Carico l'elenco delle mappe inserite */
			   ...
			   if(gdrcd_query($mappe, 'num_rows')>0){ ?>
		         ...
		         <select name="mappa">
				    <!-- Opzione "Nessuna" -->
				    <option value="-1"><?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['locations']['map_id_default']); ?></option><!-- Opzione "Nessuno" -->
		         <?php while($option=gdrcd_query($mappe, 'fetch')){ ?>
		  ...
		  <div class='form_field'>
	         <input type="checkbox"
			        name="privata" 
			        <?php if ($loaded_location['privata']==1) {?> 
					checked="checked"
					<?php } ?>
					value="is_privat" />
		  </div>
		  ...
		  <div class='form_field'>
			 ...
			 if(gdrcd_query($nomi, 'num_rows')>0||gdrcd_query($gilde, 'num_rows')>0){ ?>
              ...
              <?php } else { /* Segnalo l'assenza di gilde o personaggi (impossibile)*/
		   ...
		   <div class='form_field'>
	          <input name="costo" 
		             value="<?php echo 0+gdrcd_filter('out',$loaded_location['costo']); ?>" />
		   </div>
           <?php }//else ?>
		   ...
		   <div class='form_submit'>  
			  ...
			  <input type="submit" 
			         value="<?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['locations']['submit']['edit']);?>" />
			  <?php	} /* Altrimenti il tasto inserisci */
					  else { ?>
			  <input type="hidden" name="op" value="insert">
			  <input type="submit" 
			         value="<?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['locations']['submit']['insert']);?>" />
			  <?php	} ?>
		   </div>
	...
	if ($numresults>0){ ?>
       ...
       <table>
          ...
          <tr>
		     ...
		     <td class="casella_titolo"><div class="titoli_elenco"><?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['locations']['map_name']); ?></div></td>
	      ...
	      <tr>
             <td class="casella_elemento"><div class="elementi_elenco"><?php echo $row['nome']; ?></div></td>
		     <td class="casella_elemento"><div class="elementi_elenco"><?php echo gdrcd_filter('out',$row['mappa_click']); ?></div></td>
     ...
     <div class="link_back">
        <a href="main.php?page=gestione_luoghi&op=new">
		   <?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['locations']['link']['new']); ?>
            <br><br><a href="main.php?page=gestione">Torna all'elenco di GESTIONE</a>
		</a>
     </div>
