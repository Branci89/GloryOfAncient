...
//Se non e' stato specificato il nome del pg
    if (isset($_REQUEST['pg']) === FALSE) {
        ...
        $query = "SELECT personaggio.*, razza.sing_m, razza.sing_f, razza.id_razza, razza.bonus_car0, razza.bonus_car1, razza.bonus_car2, razza.bonus_car3, razza.bonus_car4, razza.bonus_car5, nazione.sing_m AS nazionem, nazione.sing_f AS nazionef, nazione.immagine AS imgnazione, nazione.id_nazione FROM personaggio LEFT JOIN razza ON personaggio.id_razza=razza.id_razza LEFT JOIN nazione ON personaggio.id_nazione=nazione.id_nazione WHERE personaggio.nome = '" . gdrcd_filter('in', $_REQUEST['pg']) . "'";
        ...
        if (gdrcd_query($result, 'num_rows') == 0) {
            ...
            $bonus_talenti = gdrcd_query("SELECT SUM(talento.bonus_car0) AS VO0, SUM(talento.bonus_car1) AS VO1, SUM(talento.bonus_car2) AS VO2, SUM(talento.bonus_car3) AS VO3, SUM(talento.bonus_car4) AS VO4, SUM(talento.bonus_car5) AS VO5 FROM talento JOIN clgpersonaggiotalento ON talento.id_talento = clgpersonaggiotalento.id_talento WHERE clgpersonaggiotalento.nome = '" . gdrcd_filter('in', $_REQUEST['pg']) . "' ");
                    ...
                    <div class="page_body">
                        ...
                        <div class="profilo"><!-- Punteggi, salute, status, classe, razza. -->
                                ...
                                <div class="profilo_voce">
                                    ...
                                    <div class="profilo_voce_valore">
                                        ...
                                        switch ($record['permessi']) {
                                            case USER: $permessi_utente = '';
                                                break;
                                            case GUILDMODERATOR: $permessi_utente = $PARAMETERS['names']['guild_name']['lead'];
                                                break;
                                            case GAMEMASTER: $permessi_utente = $PARAMETERS['names']['master']['sing'];
                                                break;
                                            case MODERATOR: $permessi_utente = $PARAMETERS['names']['moderators']['sing'];
                                                break;
                                            case SUPERUSER: $permessi_utente = $PARAMETERS['names']['administrator']['sing'];
                                                break;
                                        }
                            ...
                            <div class="profilo_voce">
                                ...
                                <div class="profilo_voce_valore">
                                    <?php
                                    if ((empty($record['sing_f']) == FALSE) || (empty($record['sing_m']) == FALSE)) {
                                        if ($record['sesso'] == 'f') {
                            ...
                            <div class="profilo_voce">
                                ...
                                <div class="profilo_voce_valore">
                                    ...
                                    <?php
                                    if ((empty($record['nazionef']) == FALSE) || (empty($record['nazionem']) == FALSE)) {
                                        if ($record['sesso'] == 'f') {
                            ...
                            <div class="profilo_voce">
                                ...
                                <div class="profilo_voce_valore"><!-- Forza -->
                                    <?php echo gdrcd_filter('out', $record['car0'] + $record['bonus_car0'] + $bonus_oggetti['BO0'] + $bonus_talenti['VO0']); ?>
                                </div>
                            </div> 

                            <div class="profilo_voce">
                                <div class="profilo_voce_label"><!-- Costituzione -->
                                    <?php echo gdrcd_filter('out', $PARAMETERS['names']['stats']['car1']); ?>:
                                </div>
                                <div class="profilo_voce_valore">
                                    <?php echo gdrcd_filter('out', $record['car1'] + $record['bonus_car1'] + $bonus_oggetti['BO1'] + $bonus_talenti['VO1']); ?>
                                </div>
                            </div>
                            ...
                            <div class="profilo_voce">
                                ...
                                <div class="profilo_voce_valore">
                                    <?php echo gdrcd_filter('out', $record['car2'] + $record['bonus_car2'] + $bonus_oggetti['BO2'] + $bonus_talenti['VO2']); ?>
                                </div>
                            </div>
                            ...
                            <div class="profilo_voce">
                                ...
                                <div class="profilo_voce_valore">
                                    <?php echo gdrcd_filter('out', $record['car3'] + $record['bonus_car3'] + $bonus_oggetti['BO3'] + $bonus_talenti['VO3']); ?>
                                </div>
                            </div>
                            ...
                            <div class="profilo_voce">
                                ...
                                <div class="profilo_voce_valore">
                                    <?php echo gdrcd_filter('out', $record['car4'] + $record['bonus_car4'] + $bonus_oggetti['BO4'] + $bonus_talenti['VO4']); ?>
                                </div>
                            </div>
                            ...
                            <div class="profilo_voce">
                                ...
                                <div class="profilo_voce_valore">
                                    <?php echo gdrcd_filter('out', $record['car5'] + $record['bonus_car5'] + $bonus_oggetti['BO5'] + $bonus_talenti['VO5']); ?>
                                </div>
                            </div>
                            ...
                            <div class="profilo_status">
                                ...
                                <div class="profilo_status_valore">
                                    <?php echo gdrcd_bbcoder(gdrcd_filter('out', $record['stato'])); ?>
                                </div>
                            </div>
