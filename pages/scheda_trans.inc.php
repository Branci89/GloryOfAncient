...
$query="SELECT  descrizione_evento, autore, data_evento, nome_interessato FROM log WHERE ( nome_interessato = '".gdrcd_filter('in',$_REQUEST['pg'])."' OR autore = '".gdrcd_filter('in',$_REQUEST['pg'])."') AND codice_evento = ".BONIFICO." ORDER BY data_evento DESC LIMIT ".$num_logs."";
$result=gdrcd_query($query, 'result');
