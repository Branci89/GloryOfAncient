	...
	*/
	if ($confirm_updating)
	{
		...
		} else
		{
			...
			$record = gdrcd_query("SELECT descrizione, descrfisica, affetti, cognome, online_status, url_img, url_img_chat, url_media, blocca_media, stato, salute FROM personaggio WHERE nome='".gdrcd_filter('get',$_REQUEST['pg'])."'");
		}
