<div class="pagina_gestione_mercato">
    ...
    if ($_SESSION['permessi'] < MODERATOR && !$_SESSION['mercante']) {
        ...
        if (isset($_POST['op']) === TRUE) {
            ...
            if (gdrcd_filter('get', $_POST['op']) == 'insert') {
                ...
                $queryInsert = "INSERT INTO oggetto (tipo, nome, urlimg, descrizione, costo, ubicabile, attacco, difesa, cariche, bonus_car0, bonus_car1, bonus_car2, bonus_car3, bonus_car4, bonus_car5, creatore, data_inserimento, car) "
                        . "VALUES (" . gdrcd_filter('in', $_POST['tipo_oggetto']) . ", "
                        . "'" . gdrcd_filter('in', $_POST['nome_oggetto']) . "',"
                        . "'" . gdrcd_filter('in', $immagine_oggetto) . "', "
        ...
        <div class="panels_box">
            ...
            <?php } ?>
            <div class="link_back">
                <a href="main.php?page=gestione">Torna all'elenco di GESTIONE</a>
            </div>
        </div>
