            ...
            <div class="panels_box">
                <div class="form_gioco">
                    <form action="popup.php?page=forum"
                        ...
                        <div class="form_field">
                            <script>edToolbar('Area0');</script> <textarea name="messaggio" id="Area0" class="ed" /><?php echo $row['messaggio']; ?></textarea>
                        </div>
                        <div class="form_info">
                ...
                <div class="panels_box">
                    <div class="form_gioco">
                        <form action="popup.php?page=forum" method="post">
                            ...
                            <div class="form_field">
                                <script>edToolbar('Area1');</script><textarea name="messaggio" id="Area1" class="ed" /><?php
                                if ($quote) {
                    ...
                    <div class="panels_box">
                        <div class="form_gioco" style="text-align: center;">
                            <form action="popup.php?page=forum"
                                ...
                                <div class="form_field">
                                    <script>edToolbar('Area2');</script> <textarea name="messaggio" id="Area2" class="ed" /></textarea>
                                </div>
                                <div class="form_info">
                                    <?php echo gdrcd_filter('out', $MESSAGE['interface']['help']['bbcode']); ?>
                                </div></font>
