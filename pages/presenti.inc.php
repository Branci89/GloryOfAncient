...
// Modifica Light per far apparire il simbolo della gilda nella lista presenti:
...
if ($record['numero']==1){
	echo '<div class="page_title"><h2>'.$record['numero'].' '.gdrcd_filter('out',$MESSAGE['interface']['logged_users']['sing']).'</h2></div>';
} else {
