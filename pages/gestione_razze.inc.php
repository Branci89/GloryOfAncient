...
<?php /*Inserimento di un nuovo record*/
    if ($_POST['op']=='insert') {  
	   ...
	   if ($_POST['icon']==""){$icon="standard_razza.png";}
	   else{$icon=gdrcd_filter('in',$_POST['icon']);}
...
<?php /*Form di inserimento/modifica*/
	...
	<form action="main.php?page=gestione_razze"
	      method="post">
          ...
          <div class='form_field'>
	         <input name="nome" 
			        value="<?php echo $loaded_record['nome_razza']; ?>" />
		  </div>
		  ...
		  <div class='form_field'>
	         <input name="car0" 
		            value="<?php echo 0+$loaded_record['bonus_car0']; ?>" />
		  </div>
		  <div class='form_label'>
		  ...
		  <div class='form_field'>
	         <input name="car1" 
		            value="<?php echo 0+$loaded_record['bonus_car1']; ?>" />
		  </div>
		  <div class='form_label'>
		  ...
		  <div class='form_field'>
	         <input name="car2" 
		            value="<?php echo 0+$loaded_record['bonus_car2']; ?>" />
		  </div>
		  <div class='form_label'>
		  ...
		  <div class='form_field'>
	         <input name="car3" 
		            value="<?php echo 0+$loaded_record['bonus_car3']; ?>" />
		  </div>
		  <div class='form_label'>
		  ...
		  <div class='form_field'>
	         <input name="car4" 
		            value="<?php echo 0+$loaded_record['bonus_car4']; ?>" />
		  </div>
		  <div class='form_label'>
		  ...
		  <div class='form_field'>
	         <input name="car5" 
		            value="<?php echo 0+$loaded_record['bonus_car5']; ?>" />
		  </div>
		  ...
		  <div class='form_field'>
	         <input name="icon" 
			        value="<?php echo $loaded_record['icon']; ?>" />
		  </div>
		  ...
		  <div class='form_field'>
	         <input name="site" 
			        value="<?php echo $loaded_record['url_site']; ?>" />
		  </div>
		  ...
		  <div class='form_submit'>  
			  ...
			  <input type="submit" 
			         value="<?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['races']['submit']['edit']);?>" />
			  <input type="hidden" name="op" value="modify">
			  <?php	} /* Altrimenti il tasto inserisci */
					  else { ?>
			  <input type="submit" 
			         value="<?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['races']['submit']['insert']);?>" />
	...
	if ($numresults>0){ ?>
       ...
       <table>
          ...
          <tr>
		     ...
		     <td class="casella_titolo"><div class="titoli_elenco"><?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['races']['avalaible']); ?></div></td>
			 <td class="casella_titolo"><div class="titoli_elenco"><?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['races']['visible']); ?></div></td>
	      ...
	      <tr class="risultati_elenco_record_gestione">
             <td class="casella_elemento"><div class="elementi_elenco"><?php echo $row['nome_razza']; ?></div></td>
		     ...
		     <td class="casella_controlli"><!-- Iconcine dei controlli -->
				...
				<div class="controllo_elenco" >
		           <form class="opzioni_elenco_record_gestione" action="main.php?page=gestione_razze" method="post">
			          <input type="hidden" name="id_record" value="<?php echo $row['id_razza']?>" />
