...
function bbdecoder($str, $escaped = false) {
    ...
    $bbcode = array(
        ...
        "#\[url\]($regexpUrl)+\[/url\]#is" => "<a href=\"\\1\" target=\"_blank\" title=\"\\2\">\\1</a>",
...
/** 	Funzione di formattazione basilare del testo.
	...
	*	- "[quote]~[/quote]"	citazione (formattazione in main.css come bb-quote)
	*   - "[justify]~[/justify]" giustificato
	*
	* @param string $str
	*
	* @return string
...
function baseformat($str)
{
	$bbtag = array(
					...
					array(
						...
						'<p align="right">~</p>',
						'<p align="left">~</p>',
		                '<div class="bb-quote"><h2>Citazione</h2>~</div>',
						'<p align="justify">~</p>',	
						'<li>'
						)
				);
